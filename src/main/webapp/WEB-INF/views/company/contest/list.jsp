					...
					<tbody>
						<c:forEach items="${list }" var="contest" varStatus="stat">
							<tr>
								...
								<td style="width: 10%;">${contest.contest_status }<button type="button" name="contestBtn" id="${contest.contest_id }" value="${contest.contest_id }"><span id="status">등록</span></button></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
