						...
						<table cellspacing='0'>
							...
							<ul class="board-pagination" >
								<c:if test="${pageMaker.prev}">
									<li><a
										href="${initParam.rootPath }/com/port/zzimlist${pageMaker.makeSearch(pageMaker.startPage - 1) }">&laquo;</a></li>
								</c:if>
								<c:forEach begin="${pageMaker.startPage }"
									...
									<li
										...
										<a
										href="${initParam.rootPath }/com/port/zzimlist${pageMaker.makeSearch(idx)}">${idx}</a>
									</li>
								</c:forEach>

								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li><a
										href="${initParam.rootPath }/com/port/zzimlist${pageMaker.makeSearch(pageMaker.endPage +1) }">&raquo;</a></li>
								</c:if>
							</ul>
						</div>
					</div>
