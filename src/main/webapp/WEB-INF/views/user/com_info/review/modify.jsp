...
<form action="modify" name="modifyForm" method="post">
	...
	<div class="container" style="background-image: url('${initParam.rootPath}/resources/image/monitor/pencil.jpg');">
		<div class="row" style="padding-top: 8em; padding-bottom: 1em; padding-right: 4em;padding-left: 4em">
			...
			<div class="col-sm-8">
				<h1 style="font-weight: 600;">후기 수정</h1>
				<hr>
			</div>
		</div>
	</div>
	...
	<div class="container"
		...
		<div class="well well" style="margin-top: 2em; margin-left: 2em; margin-right: 2em;">
				...
				<div class="col-sm-5">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							class="form-control" id="review_title" name="review_title" type="text"
				...
				<div class="col-sm-3">
					<div class="input-group">
						<span class="input-group-addon"><i
							...
							id="review_writer" name="review_writer" value="${review.review_writer }" readonly>
					</div>
				</div>
			</div>
			<hr>
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="form-group">
						...
						<textarea name="review_strong" rows="10" class="form-control" id="good">${review.review_strong }</textarea>
					</div>
				</div>
			</div>
			<hr>
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="form-group">
						...
						<textarea name="review_weak" rows="10" class="form-control" id="bad">${review.review_weak }</textarea>
					</div>
				</div>
			</div>
			<hr>
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="form-group">
						...
						<textarea name="review_toCEO" rows="10" class="form-control" id="want">${review.review_toCEO }</textarea>
					</div>
				</div>
			</div>
			<hr>
			...
			<div class="row">
				<div class="col-sm-2"></div>
				<div class="col-sm-4">
					<button type="button" class="btn btn-info btn-block" onclick="validateCheck()">수정</button>
				</div>
				<div class="col-sm-4">
