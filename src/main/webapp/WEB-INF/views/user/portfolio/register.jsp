		...
		<div class='column-left'>	
			<div class='com-contest-head'>
				<div class='title-wrapper'>
					<div class='column-title'>포트폴리오 글작성</div>
				</div>
			<form action="register" name="registerForm" method="post">
				<div class='wrapper'>
					<div class='com-qna-title'>
                      <div class="row" hidden="" >
		                        <input id="user_id" name="user_id" value="${user_login_id }">
		                        <input id="port_id" name="port_id" value="port_id">
						    </div>
							<span class="input-group-addon">경험</span>&nbsp;&nbsp;&nbsp; <input
				                  class="port_exp" id="port_exp" name="port_exp" type="text"
				                  style="width: 35%" >
				            <span class="input-group-addon" style="padding-left: 3em;">기술</span> <input
				                  class="port_skill" id="port_skill" name="port_skill"
				                  style="width: 35%" ><br>
							<span class="input-group-addon">흥미</span>&nbsp;&nbsp;&nbsp; <input
				                  class="port_interest" id="port_interest" name="port_interest" type="text"
				                  style="width: 35%" >
				            <span class="input-group-addon" style="padding-left: 3em;">수상</span> <input
				                  class=port_award id="port_award" name="port_award"
				                  style="width: 35%" ><br>
							<span class="input-group-addon">링크</span>&nbsp;&nbsp;&nbsp; <input
				                  class="port_link" id="port_link" name="port_link" type="text"
				                  style="width: 35%" >
				            <span class="input-group-addon" style="padding-left: 3em;">자격증</span> <input
				                  class="port_license" id="port_license" name="port_license"
				                  style="width: 35%" ><br>
				            <span class="input-group-addon">이미지</span>&nbsp;&nbsp;&nbsp; <input
				                  class="port_link" id="port_img" name="port_img" type="text"
				                  style="width: 35%" >
					</div>
			...
			<div class="section_login">
				<div class="wrapper">
				    ...
				    <span class="pure-checkbox" style="float: left;">
                  	  <input id="checkboxtoggle" name="checkbox" type="ch  eckbox">
