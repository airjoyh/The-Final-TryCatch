...
public class CompileHandler {
   ...
   public String java(String...args) throws ExecuteException, IOException {
	   ...
	   ExecuteStreamHandler esh = new PumpStreamHandler(new FileOutputStream("c:/coding/print.txt"));
